...
33. Will I pay customs duties or import taxes on an international order?
    Orders shipped outside our domestic delivery area may be subject to customs duties, import taxes, or handling fees set by the destination country. These charges aren't included in the total you pay at checkout, and are collected by the carrier or the customs authority on delivery. If you need exact rates before ordering, check with your local customs office.

34. I was charged twice for the same order. What should I do?
    First check whether you're seeing two separate authorizations for a single order, which can happen when items ship separately (see question 19) and usually clears within 5 business days. If two identical charges are still showing after that, contact support with your order number and both transaction dates, and we'll refund the duplicate within 3–10 business days.

35. The item I bought is now on sale. Can I get the difference refunded?
    If an item you ordered goes on sale within 14 days of your purchase date, contact support with your order number and we'll refund the difference to your original payment method. Price adjustments apply once per order, and don't apply to clearance items or bundle promotions.
